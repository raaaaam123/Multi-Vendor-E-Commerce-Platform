...
const VendorHeader = () => {
  ...
  const getPageTitle = (pathname) => {
    ...
    if (pathname.startsWith("/vendor/products/edit/")) return "Edit Product";
    return paths[pathname] || "Vendor Panel";
  };
  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6">
      ...
      <div className="flex items-center gap-2">
        <Link
          to="/"
          className="hidden sm:inline-flex text-sm font-medium text-gray-600 hover:text-purple-600"
        >
          View Store
        </Link>
